...
app.component('app-content',{
    ...
    components: {
        'marquee-box': {
            template: '<div class="marquee shadow"><div>搭公車時請全程配戴口罩，勸導不聽者，最高可罰15,000元。Face mask must be worn when taking the bus. Those refuse to comply will be fined up to 15,000 NT dollars. バスを乗る際はマスクを着用し、違反者には最高NT$15,500円の罰金が科されます。</div></div>'
        },
        'campus-bus-list': {
